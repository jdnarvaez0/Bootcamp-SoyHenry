...
// Tu código acá:
let div = document.getElementById("createBy");
div.innerHTML = "Juan David";
...
buildToDo.prototype.completeToDo = function () {
  this.descripción = true;
};
